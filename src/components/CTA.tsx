...
export default function CTA() {
  ...
  return (
    <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary-700 via-primary-800 to-surface-900">
      <div className="max-w-5xl mx-auto text-center">
        <div className="animate-fade-in">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 md:gap-6 mb-6 sm:mb-8 md:mb-12">
            {['7 dias grátis', 'Sem cartão de crédito', 'Cancele quando quiser', 'Suporte via WhatsApp'].map((benefit, index) => (
              <div
                key={index}
                className="flex items-center gap-1.5 sm:gap-2 text-white animate-fade-in"
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-6 sm:mb-8">
            <a
              ...
              className="group bg-white text-primary-600 px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg hover:bg-surface-100 transition-all shadow-card flex items-center justify-center gap-2"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group bg-white/10 backdrop-blur-sm text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg border-2 border-white hover:bg-white/20 transition-all flex items-center justify-center gap-2"
            >
            ...
            <a
              href="#contato"
              className="bg-transparent text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl font-semibold text-base sm:text-lg border-2 border-white hover:bg-white/10 transition-all flex items-center justify-center gap-2"
            >
              Ver demonstração
            </a>
          </div>
