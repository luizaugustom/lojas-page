...
export default function WhatsAppFloat() {
  ...
  const message = 'Olá! Tenho interesse no Sistema Montshop e gostaria de saber mais informações.'
  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 animate-bounce-slow">
      <a
        ...
        className="group relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-green-500 hover:bg-green-600 rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300"
